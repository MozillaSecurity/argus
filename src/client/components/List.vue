    ...
    >
      <el-table-column type="expand">
        <template slot-scope="props">
          ...
          <p>
            Remote:
            <a :href="props.row.remote">{{ props.row.remote }}</a>
          </p>
      ...
      <el-table-column prop="name" label="Name" width="130">
        <template slot-scope="scope">
          <el-popover trigger="hover" placement="right">
            ...
            <p>
              Remote:
              <a :href="scope.row.remote">{{ scope.row.remote }}</a>
            </p>
      ...
      <el-table-column prop="commits" label="Commits" width="110">
        <template slot-scope="scope">{{ scope.row.commits }}</template>
      </el-table-column>

      <el-table-column prop="status" label="Status" width="100" sortable :format="formatter"></el-table-column>
      ...
      <el-table-column label="Operations">
        <template slot-scope="scope">
          <el-button size="mini" @click="handleForceUpdate(scope.$index, scope.row)">Force Update</el-button>
